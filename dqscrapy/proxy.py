PROXIES = [
    ...
    {"ip_port": "111.126.231.11:8118"},  # tor via privoxy
    {"ip_port": "221.226.67.202:8118"},  # tor via privoxy
    {"ip_port": "182.36.175.179:8888"},  # tor via privoxy
    {"ip_port": "60.211.60.89:8888"},  # tor via privoxy
    # {"ip_port": "120.202.249.202:8080"},  # tor via privoxy
    # {"ip_port": "64.31.22.131:7808"},  # tor via privoxy
]
'''
